	...
	<div class="chat-container">
		...
		<div id="container" class="container">
			...
			<input type="hidden" id="userName" name="userName"
				value="${member.id}"> <input type="hidden" id="roomNumber"
				value="${roomNumber}">
			<div id="chating" class="chating"
				style='background-image: url(<c:url value='/resources/img2/jv.gif'/>);background-repeat:no-repeat;background-position: center;'></div>
