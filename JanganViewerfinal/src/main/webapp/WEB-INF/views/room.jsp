...
<link href="${path}/resources/css/room.css" rel="stylesheet" />	
<link rel="stylesheet" href="${path}/resources/css/fontello.css"> 
<link rel="stylesheet" href="${path}/resources/css/animation.css">
<link rel="stylesheet" href=".${path}/resources/css/fontello-embedded.css">
...
@keyframes fadeIn {
  ...
  to {background:darken(rgba(255,255,255,0.1),90%);opacity:1;padding:0 0 110px 0;} /*처음 보여지는 곳 */
}
@keyframes fadeOut {
...
<script type="text/javascript">
	...
	function getRoomUser(id) {
		...
		commonAjax('/getRoomUser', test , 'post', function(result) {
			createChatingRoom(result);
		});
	}
	...
	function createChatingRoom(res) {
		if (res != null) {
			var tag = "<main class='row title'><ul><li class='num'>순서</li><li class='room'>방 이름</li><li class='sessionId'>작성자</li><li class='go'>참가</li></ul></main>";
			res
...
<div class="container">
<span>
<a href='javascript:history.go(-1)' class="back"><img id="back-img" src="${pageContext.request.contextPath}/resources/img2/back.png"></a>
		<h1>채팅방</h1>
	</span>
		<div class="wrapper">	
		</div>
...
<table class="inputTable">
				<tr>
					<th>방 제목</th>
					<th><input type="text" name="roomName" id="roomName" placeholder="방제목을 지정해주세요" class="input_box" style="height:50px; max-width:1600px;  font-size: 1.5rem;
					font-family: sans-serif; "></th>
					<th rowspan="2"><button id="createRoom" class="btn">방 만들기</button>
